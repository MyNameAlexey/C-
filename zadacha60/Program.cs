...
int [,,] ArrayWhithRandomNonRepeating(int[,,] arr, int minVal, int maxVal)
{
    int temp;
    bool check = false;
...
int leaf = Entry("Введите третью длину массива: ");
int row = Entry("Введите вторую длину массива: ");
int column = Entry("Введите первую длину массива: ");
...
array = ArrayWhithRandomNonRepeating(array, miNum, maxNum);
PrintMatrix(array);
Console.WriteLine();